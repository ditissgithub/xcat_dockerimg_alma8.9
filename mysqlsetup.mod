...
sub mysqlstart {
    ...
    if ($::osname eq 'AIX') {
        ...
        $cmd = $cmd2;
        $cmd .= "/usr/bin/mysqld --user=mysql --basedir=$::installdir --datadir=/var/lib/mysql --log-error=/var/lib/mysql/$hostname.err --pid-file=/var/lib/mysql/$hostn                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ame.pid --socket=/tmp/mysql.sock --port=$MYSQL_PORT &";
        ...
        if ($::MariaDB == 1) {    # running MariaDB
            ...
            if ($::linuxos =~ /rh.*|ol.*|rocky.*|alma.*/) {
                $cmd = "nohup /usr/bin/mysqld_safe --user=mysql --basedir=/usr --datadir=/var/lib/mysql --socket=/var/lib/mysql/mysql.sock --port=$MYSQL_PORT > /dev/nul                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       l 2>&1 &";
            } else {              # SLES
                $cmd = "/usr/bin/mysqld --user=mysql --basedir=/usr --datadir=/var/lib/mysql --socket=/var/lib/mysql/mysql.sock --port=$MYSQL_PORT &";
            }
        }
...
# Check for process running
    ...
    if (grep(/$mysql_process_name/, @output)) {
        ...
        my $cmd_start = "nohup /usr/bin/mysqld_safe --user=mysql --basedir=/usr --datadir=/var/lib/mysql --socket=/var/lib/mysql/mysql.sock --port=$MYSQL_PORT > /dev/nu                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ll 2>&1 &";
        system($cmd_start);
...
"ulimit -n unlimited; ulimit -m unlimited; ulimit -d unlimited;ulimit -f unlimited; ulimit -s unlimited;";
    ...
    if ($::RUNCMD_RC != 0)
    {
        xCAT::MsgUtils->message(
            "I",
"Warning, mysqladmin -u root password command failed, trying to set root password in MySQL. If root id has been defined in MySQL, and has a password then this message c                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       an be ignored."
        );
...

{
    ...
    {
        my $message =
"unixODBC is not installed.  If on AIX, it should be first obtained from the xcat dependency tarballs and installed before we can setup the ODBC. If on Linux, install f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       rom the OS CDs.";
    ...
    if (($::linuxos =~ /rh.*|ol.*|rocky.*|alma.*/) || ($::osname eq 'AIX'))
    {
        ...
        {
            my $message =
"xcat-connector-odbc is not installed.  It should be first obtained from the xcat dependency tarballs and installed before running this command. If on Linux, install fr                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       om the OS CDs.";
            xCAT::MsgUtils->message("E", "$message");
            exit(1);
        }
    }
